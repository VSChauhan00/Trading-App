        ...
        <footer style={{ backgroundColor: "rgb(250, 250, 250" }}>
            <div className='container border-top mt-5'>
                <div className='row mt-5'>
                    <div className='col'>
                        <div>
                            <img src='media/images/tradinx.svg' style={{ width: "50%" }} alt='Icon' />
                            <p style={{letterSpacing: '10px', padding:'1.8%', paddingLeft:'5%', fontWeight:'bold'}}>TRADINX</p>
                        </div>
                        <p>
                            &copy; 2010 - 2026, Tradinx Broking Ltd. <br /> All rights reserved.
                        </p>
                    </div>
                    <div className='col'>
                        <p>Company</p>
                        ...
                        <a href=''>Careers</a><br />
                        <a href=''>Tradinx Cares (CSR)</a><br />
                        <a href=''>Tradinx.tech</a><br />
                ...
                <div className='mt-5 text-muted' style={{ fontSize: "12px" }}>
                    <p>Tradinx Broking Ltd.: Member of NSE, BSE, MCX & MSEI – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Tradinx Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: Tradinx Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@Tradinx.com, for DP related to dp@Tradinx.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
